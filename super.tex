...
%\section{Grupos superresolubles}
\label{super}

\begin{definition}
	\index{Grupo!superresoluble}
...
\begin{proof}
	...
	triviales. 
	%Como $G/M$ es superresoluble, la sucesión $1\supseteq
...
%\begin{proposition}\
%	\begin{enumerate}
%		\item Si un grupo superresoluble admite una serie de composición,
%			entonces es finito. 
%		\item Si un grupo superresoluble satisface la condición de minimal en
%			subgrupos entonces es finito.
%	\end{enumerate}
%\end{proposition}
%
%\begin{proof}
%	%Para probar la segunda afirmación obsevemos que todo cociente de $G$ es superresoluble 
...
%\begin{example}
%	El grupo $\Sym_3$ es superresoluble pero no es nilpotente. 
%\end{example}
